...
return p;
 ...
 extern "C" {
    extern void sgemm_kernelIfEvPKT_S2_PS0_i_wrapper(void *args);
}

void cuda_sgemm_kernelIfEvPKT_S2_PS0_i_wrapper(void* args) {
...
//    vx_printf("kernel_warpper: group=(%d, %d) thread=(%d, %d)\n", blockIdx.x, blockIdx.y, thread_id_x, thread_id_y);
    ...
    sgemm_kernelIfEvPKT_S2_PS0_i_wrapper((void **)args);
}

vx_kernel_func_cb callbacks[] = {
    cuda_sgemm_kernelIfEvPKT_S2_PS0_i_wrapper, 
};
